...
def display_start(screen, screen_width, screen_height):
    ...
    subtitle_surf = font_regular.render(" Push \"Enter\" to play ", False, (0, 0, 25))
    ...
    hiscores_surf = font_small.render(" L - List high scores ", False, (0, 0, 25))
    hiscores_rect = hiscores_surf.get_rect(midtop = (screen_width/2, title_rect.bottom + 200))
    pygame.draw.rect(screen, (156, 156, 156), hiscores_rect)        

    settings_surf = font_small.render(" S - Settings ", False, (0, 0, 25))
    settings_rect = settings_surf.get_rect(topleft = (hiscores_rect.left, title_rect.bottom + 250))
    pygame.draw.rect(screen, (156, 156, 156), settings_rect)        

    help_surf = font_small.render(" H - Help ", False, (0, 0, 25))
    help_rect = help_surf.get_rect(topleft = (hiscores_rect.left, title_rect.bottom + 300))
    pygame.draw.rect(screen, (156, 156, 156), help_rect)
...
def display_settings(screen, screen_width, screen_height):
    ...
    title_surf = font_title.render("Settings", False, (156, 156, 156))
    title_rect = title_surf.get_rect(midtop = (screen_width/2, screen_height/4))
    
    subtitle1_surf = font_regular.render(" 1 - controls: ", False, (0, 0, 25))
    subtitle1_rect = subtitle1_surf.get_rect(topleft = (screen_width/4, title_rect.bottom + 75))
    pygame.draw.rect(screen, (156, 156, 156), subtitle1_rect)
    
    subtitle2_surf = font_regular.render(" 2 - controls: ", False, (0, 0, 25))
...
def display_help(screen, screen_width, screen_height):
    ...
    title_surf = font_title.render("Help", False, (156, 156, 156))
    title_rect = title_surf.get_rect(midtop = (screen_width/2, screen_height/4))
    
    msg1_a_surf = font_small.render(" Use keyboard to move left <-> right ", False, (0, 0, 25))
    msg1_a_rect = msg1_a_surf.get_rect(midtop = (screen_width/2, title_rect.bottom + 75))
    pygame.draw.rect(screen, (156, 156, 156), msg1_a_rect)
    
    msg1_b_surf = font_small.render(" and shoot (see Settings). ", False, (0, 0, 25))
    msg1_b_rect = msg1_b_surf.get_rect(topleft = (msg1_a_rect.left, title_rect.bottom + 100))
    pygame.draw.rect(screen, (156, 156, 156), msg1_b_rect)

    msg2_a_surf = font_small.render(" Avoid falling enemy projectiles and ", False, (0, 0, 25))
    msg2_a_rect = msg2_a_surf.get_rect(topleft = (msg1_a_rect.left, title_rect.bottom + 150))
    pygame.draw.rect(screen, (156, 156, 156), msg2_a_rect)        

    msg2_b_surf = font_small.render(" descending kittens! ", False, (0, 0, 25))
    msg2_b_rect = msg2_b_surf.get_rect(topleft = (msg1_a_rect.left, title_rect.bottom + 175))
    pygame.draw.rect(screen, (156, 156, 156), msg2_b_rect)        

    msg3_a_surf = font_small.render(" Do not let invading kittens reach ", False, (0, 0, 25))
    msg3_a_rect = msg3_a_surf.get_rect(topleft = (msg1_a_rect.left, title_rect.bottom + 225))
    pygame.draw.rect(screen, (156, 156, 156), msg3_a_rect)    
    
    msg3_b_surf = font_small.render(" the ground! ", False, (0, 0, 25))
...
def display_pause(screen, screen_width, screen_height):
    ...
    pause_surf = font_title.render("Game paused", False, (156, 156, 156))
...
def display_game_over(screen, screen_width, screen_height):
    ...
    title_surf = font_title.render("Game over!", False, (156, 156, 156))
    title_rect = title_surf.get_rect(midtop = (screen_width/2, screen_height/4))
    ...
    pygame.draw.rect(screen, (156, 156, 156), msg1_rect)        

    msg2_surf = font_small.render(" S - Settings ", False, (0, 0, 25))
    msg2_rect = msg2_surf.get_rect(topleft = (msg1_rect.left, title_rect.bottom + 250))
    pygame.draw.rect(screen, (156, 156, 156), msg2_rect)        

    msg3_surf = font_small.render(" H - Help ", False, (0, 0, 25))
    msg3_rect = msg3_surf.get_rect(topleft = (msg1_rect.left, title_rect.bottom + 300))
    pygame.draw.rect(screen, (156, 156, 156), msg3_rect)        
